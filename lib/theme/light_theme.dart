...
final lightTheme = _base.copyWith(
  primaryColor: AppColors.rolePrimaryDay,
  ...
  bottomNavigationBarTheme: _base.bottomNavigationBarTheme.copyWith(
    backgroundColor: AppColors.neutralNeutral95,
    elevation: 0,
    showSelectedLabels: true,
    showUnselectedLabels: true,
    selectedItemColor: AppColors.rolePrimaryDay,
    unselectedItemColor: AppColors.neutralNeutral0,
